// Indirizzi IP reali dei due siti di esempio, verificati con una vera
// risoluzione DNS al momento in cui questa pagina è stata scritta (non
// inventati, a differenza di altri progetti di questa raccolta come
// dns-domain-explorer). Restano comunque solo un'istantanea: molti siti
// reali, specie dietro una CDN, possono rispondere con IP diversi nel tempo.
const HOST_IPS = {
    'it.wikipedia.org': '208.80.153.224',
    'www.istruzione.it': '23.192.118.19'
};
...
function buildSteps(host) {
    ...
    return [
        ...
        { active: ['client', 'dns'], edge: 'client-dns', text: `Il DNS risponde con l'indirizzo IP corrispondente: <strong>${ip}</strong>.` },
